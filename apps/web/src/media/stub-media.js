...
function stubImage(prompt, title = 'Storyboard scene', dimensions = {}) {
  const width = Number(dimensions.width) || 1024; const height = Number(dimensions.height) || 1024;
