...
const els = {
  ...
  sceneAudioInputLevel: document.getElementById('sceneAudioInputLevel'),
  sceneAudioInputLevelText: document.getElementById('sceneAudioInputLevelText'),
  sceneAudioNoiseGate: document.getElementById('sceneAudioNoiseGate'),
  sceneAudioCalibrateBtn: document.getElementById('sceneAudioCalibrateBtn'),
  sceneAudioGateStatus: document.getElementById('sceneAudioGateStatus'),
